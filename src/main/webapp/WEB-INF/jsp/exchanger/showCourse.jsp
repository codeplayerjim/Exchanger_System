...
<body>
				...
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
							...
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="${pageContext.request.contextPath}/exchanger/selectedCourse" id="form1" method="post">
				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${courseList}" var="item">
								<tr>
									...
									<td>${item.score}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='/exchanger/excSelectedCourse?id=${item.courseid}'">选课</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
	...
	<script type="text/javascript">
        ...
        <c:if test="${pagingVO != null}">
        if (${pagingVO.currentPageNo} == ${pagingVO.totalCount}) {
